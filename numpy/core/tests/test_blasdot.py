...
def test_dot_array_order():
    ...
    for arr_type, prec in dtypes_prec.iteritems():
        for a_order in orders:
            ...
            assert_array_almost_equal_nulp(np.dot(a, a), a.dot(a))
            ...
            assert_array_almost_equal_nulp(a_T.dot(a_T), a.T.dot(a.T))
            assert_array_almost_equal_nulp(a.dot(a_T), a.dot(a.T))
            assert_array_almost_equal_nulp(a_T.dot(a), a.T.dot(a))
            ...
            for b_order in orders:
                ...
                assert_array_almost_equal_nulp(a_T.dot(b), a.T.dot(b))
                assert_array_almost_equal_nulp(b_T.dot(a), b.T.dot(a))
                # (b'.a)' = a'.b
                ...
                for c_order in orders:
                    ...
                    assert_array_almost_equal_nulp(c.T.dot(b.T), c_T.dot(b_T))
